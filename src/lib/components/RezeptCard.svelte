<script>
	...
	$: if (rezept) {
		// Alle Zutaten kombinieren (Basis + Vegan-Variante falls vorhanden)
		activeIngredients = [
				...
				<div class="hero-grid">
					<div class="info-card">
						...
						<div class="info-grid">
							...
							<div class="info-item">
								<span class="icon"
									>{schwierigkeitEmoji[rezept.schwierigkeit].split(' ')[0]}</span
								>
								<div>
									<span class="label">Schwierigkeit</span>
									<span class="value"
										>{schwierigkeitEmoji[rezept.schwierigkeit].split(' ')[1]}</span
									>
								</div>
							</div>
							<div class="info-item">
