<script>
  ...
  import { getMonthName, getSeasonDisplay, getCurrentMonth } from '$lib/utils/seasonHelper.js';
      ...
      <div class="hero-grid">
        ...
        {#if produkt.regional_data}
          <div class="hero-section sustainability">
            <div class="sus-row">
              <div class="score-mini" style="border-color: {getScoreColor(regionalScore)}; color: {getScoreColor(regionalScore)}">
                {regionalScore}
              </div>
